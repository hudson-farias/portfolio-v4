...
const GitlabIcon = ({ className }: { className?: string }) => {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
      <path d="m23.955 9.095-.892-2.747L12 1.5 8.937 6.348H8.944L.937 6.348l-.892 2.747 10.955 7.955L.045 9.095l.892 2.747L12 22.5l11.063-10.658.892-2.747-10.955 7.955 10.955-7.955z" />
    </svg>
  )
}
